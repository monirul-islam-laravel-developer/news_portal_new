    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Video Edit</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('video.update',['id'=>$video->id])}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{$video->title}}" id="inputEmail3" placeholder="Video Title"/>
                                        @error('title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{$video->link}}" placeholder="Link"/>
                                        @error('link')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <img src="{{asset($video->image)}}" alt="" height="120" width="150">
                                        @error('image')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="checkbox" id="switch1" value="1" class="form-control" name="status" @if($video->status ==1) checked @endif data-switch="bool"/>
