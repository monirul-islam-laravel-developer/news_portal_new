                        ...
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('blog.new')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="inputEmail3" placeholder="Blog Title"/>
                                        @error('title')
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-2 col-form-label">Body</label>
                                    <div class="col-10">
                                        <textarea type="text"  class="form-control @error('body') is-invalid @enderror" name="body" id="summernote" placeholder="Color Description"></textarea>
                                        @error('body')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-2 col-form-label">Image</label>
                                    <div class="col-10">
