    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Reporter Add</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('slider.new')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="inputEmail3" placeholder="Reporter Name"/>
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" id="inputEmail3" placeholder="Reporter Designation"/>
                                        @error('designation')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
