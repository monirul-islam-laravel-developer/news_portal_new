                        ...
                        <div class="col-lg-7 col-md-7">
                            <div class="themesbazar_led_active owl-carousel">
                                ...
                                <div class="secOne_newsContent">
                                    <div class="sec-one-image">
                                        <a href="{{route('news-detail',['id'=>$sliderNews,$sliderNews->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sliderNews->image)}}" alt="{{$sliderNews->title}}" title="{{$sliderNews->title}}’"></a>

                                        <h6 class="sec-small-cat">
                                            <a href="#">  @php
                                                    // Parse the created_at date into a Carbon instance
                                                    $created_at = \Carbon\Carbon::parse($sliderNews->created_at);
                                        ...
                                        <h1 class="sec-one-title">
                                            <a href="{{route('news-detail',['id'=>$sliderNews,$sliderNews->slug])}}">{{$sliderNews->title}} </a>
                                        </h1>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="sec-one-item">
                                <div class="row">
                                    ...
                                    <?php
                                    $frontnews_2 = \App\Models\Post::where('status', 1)->skip(10)->take(2)->get();
                                    $frontnews_5 = \App\Models\Post::where('status', 1)->skip(30)->take(5)->get();
                                    $frontnews_6 = \App\Models\Post::where('status', 1)->skip(100)->take(6)->get();


                                    ?>


                                    @foreach($frontnews_2 as $front2)
                                    <div class="themesBazar-2 themesBazar-m2">
                                        <div class="sec-one-wrpp">
                                            <div class="secOne-news">
                                                <div class="secOne-sub-image">
                                                    <a href="{{route('news-detail',['id'=>$front2->id,'slug'=>$front2->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($front2->image)}}" alt="{{$front2->title}}" title="{{$front2->title}}"></a>
...
{{--                                                    <a href="135.html" class="video-icon1"><i class="la la-play"></i></a>--}}
                                                ...
                                                <h4 class="secOne-title2">
                                                    <a href="{{route('news-detail',['id'=>$front2->id,'slug'=>$front2->slug])}}"> {{$front2->title}}</a>
                                                </h4>
                                            </div>

                                            <h6 class="cat-meta">
                                                <a href="#"> <i class="lar la-newspaper"></i>  @php
                                                        // Parse the created_at date into a Carbon instance
                                                        $created_at = \Carbon\Carbon::parse($front2->created_at);
                        ...
                        <div class="col-lg-5 col-md-5">
                            ...
                            @foreach($frontnews_5 as $front5)
                            <div class="secOne-smallItem">
                                <div class="secOne-smallImg">
                                    <a href="{{route('news-detail',['id'=>$front5->id,'slug'=>$front5->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($front5->image)}}" alt="{{$front5->title}}" title="{{$front5->title}}"></a>

                                    <div class="sec-small-cat1">
                                        <a href="#"> @php
                                                // Parse the created_at date into a Carbon instance
                                                $created_at = \Carbon\Carbon::parse($front5->created_at);
                                    ...
                                    <h5 class="secOne_smallTitle">
                                        <a href="{{route('news-detail',['id'=>$front5->id,'slug'=>$front5->slug])}}">{{$front5->title}}</a>
                                    </h5>
                                </div>
                            </div>
                            @endforeach
                    ...
                    <div class="sec-one-item2">
                        <div class="row">
                            ...
                            @foreach($frontnews_6 as $front6)
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="sec-one-wrpp2">
                                    <div class="secOne-news">
                                        <div class="secOne-image2">
                                            <a href="{{route('news-detail',['id'=>$front6->id,'slug'=>$front6->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($front6->image)}}" alt="{{$front6->title}}" title="{{$front6->title}}"></a>



                                        </div>
                                        <h4 class="secOne-title2">
                                            <a href="{{route('news-detail',['id'=>$front6->id,'slug'=>$front6->slug])}}"> {{$front6->title}} </a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="cat-meta">
                                        <a href="#"> <i class="lar la-newspaper"></i>   @php
                                                // Parse the created_at date into a Carbon instance
                                                $created_at = \Carbon\Carbon::parse($front6->created_at);
                    ...
                    <div class="live-item">
                        ...
                        <div class="popup-wrpp">
                            <div class="live_image">
                                <img src="{{asset('/')}}frontend/assets/images/livetv.jpg" alt="লাইভ টিভি">
...
{{--                    <form action="#" method="get" class="date_content">--}}
{{--                        <input type="hidden" name="_token" value="GyMtLxk7RgHUPGL1bQxwfSHRjMlHPXkFVsBKE3Es">                        <div class="last-date">--}}
...
{{--                    </form>--}}
                        ...
                        <div class="tab-pane active show  fade" id="recent" role="tabpanel"     aria-labelledby="recent">
                            <div class="news-titletab">
                                ...
                                <div class="tab-image tab-border">
                                    <a href="{{route('news-detail',['id'=>$lnews20->id,$lnews20->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($lnews20->image)}}" alt="{{$lnews20->title}}" title="{{$lnews20->title}}"></a>

                                    <a href="#" class="video-icon3">  </a>


                                    <h4 class="tab_hadding"><a href="{{route('news-detail',['id'=>$lnews20->id,$lnews20->slug])}}"> {{$lnews20->title}}</a></h4>
                        ...
                        <div class="tab-pane fade" id="popular" role="tabpanel" aria-labelledby="popular">
                            <div class="news-titletab">
                                ...
                                <div class="tab-image tab-border">
                                    ...
                                    <a href="{{route('news-detail',['id'=>$popular_news->id,$popular_news->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($popular_news->image)}}" alt="{{$popular_news->title}}" title="{{$popular_news->title}}"></a>

                                    <a href="#" class="video-icon3">  </a>


                                    <h4 class="tab_hadding"><a href="{{route('news-detail',['id'=>$popular_news->id,$popular_news->slug])}}">{{$popular_news->title}}</a></h4>
                                    <div class="archive-conut">
                                        {{ str_replace(range(0, 9), ['০', '১', '২', '৩', '৪', '৫', '৬', '৭', '৮', '৯'], $loop->iteration) }}
    ...
    <!--=======================
                        ...
                        ==========================-->
    <?php
    $jatio_h = \App\Models\Category::where('status', 1)->skip(0)->take(1)->first();
    $rajniti_h = \App\Models\Category::where('status', 1)->skip(1)->take(1)->first();
    $antorjatik_h = \App\Models\Category::where('status', 1)->skip(2)->take(1)->first();
    $totthoprojukti_h = \App\Models\Category::where('status', 1)->skip(5)->take(1)->first();
                    ...
                    <div class="col-lg-12 col-md-12">
                            ...
                            <ul class="nav nav-pills" id="categori-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link" id="categori-tab4" data-bs-toggle="pill" data-bs-target="#Info-tabs4" role="tab" aria-controls="Info-tabs4" aria-selected="false">
                                        {{$totthoprojukti_h->category_name}}
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane active show  fade" id="Info-tabs1" role="tabpanel" aria-labelledby="categori-tab1 ">
                                ...
                                <div class="row">
                                    <?php
                                    $jatioh = \App\Models\Category::where('status', 1)->skip(0)->take(1)->get();

                                    if ($jatioh->isNotEmpty()) {

                                        $jatioh8 = \App\Models\Post::where('category_id', $jatio_h->id)->skip(0)->take(8)->get();
                                    }

                                    ?>

                                    @foreach($jatioh8 as $jati8)
                                    <div class="themesBazar-4 themesBazar-m2">
                                        <div class="sec-two-wrpp">
                                            <div class="section-two-image">
                                                <a href="{{route('news-detail',['id'=>$jati8->id,'slug'=>$jati8->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($jati8->image)}}" alt="{{$jati8->title}}" title="{{$jati8->title}}"></a>

                                                <a href="#" class="video-icon3">  </a>
                                            </div>

                                            <h5 class="sec-two-title">
                                                <a href="{{route('news-detail',['id'=>$jati8->id,'slug'=>$jati8->slug])}}">{{$jati8->title}}</a>
                                            </h5>
                                        </div>
                                    </div>
                                        @endforeach
                            ...
                            <div class="tab-pane fade" id="Info-tabs2" role="tabpanel" aria-labelledby="categori-tab2">
                                ...
                                <div class="row">
                                    <?php
                                    $rajnitih = \App\Models\Category::where('status', 1)->skip(1)->take(1)->get();

                                    if ($rajnitih->isNotEmpty()) {

                                        $rajnitih8 = \App\Models\Post::where('category_id', $rajniti_h->id)->skip(0)->take(8)->get();
                                    }

                                    ?>
                                    @foreach($rajnitih8 as $rajniti8)
                                    <div class="themesBazar-4 themesBazar-m2">
                                        <div class="sec-two-wrpp">
                                            <div class="section-two-image">
                                                <a href="{{route('news-detail',['id'=>$rajniti8->id,'slug'=>$rajniti8->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($rajniti8->image)}}" alt="{{$rajniti8->title}}" title="{{$rajniti8->title}}"></a>

                                                <a href="#" class="video-icon3">  </a>
                                            </div>

                                            <h5 class="sec-two-title">
                                                <a href="{{route('news-detail',['id'=>$rajniti8->id,'slug'=>$rajniti8->slug])}}">{{$rajniti8->title}}</a>
                                            </h5>
                                        </div>
                                    </div>
                                        @endforeach
                            ...
                            <div class="tab-pane fade" id="Info-tabs3" role="tabpanel" aria-labelledby="categori-tab3">
                                ...
                                <div class="row">
                                    <?php
                                    $antorjatikh = \App\Models\Category::where('status', 1)->skip(2)->take(1)->get();

                                    if ($antorjatikh->isNotEmpty()) {

                                        $antorjatikh8 = \App\Models\Post::where('category_id', $antorjatik_h->id)->skip(0)->take(8)->get();
                                    }

                                    ?>

                                    @foreach($antorjatikh8 as $antorjatik8)
                                    <div class="themesBazar-4 themesBazar-m2">
                                        <div class="sec-two-wrpp">
                                            <div class="section-two-image">
                                                <a href="{{route('news-detail',['id'=>$antorjatik8->id,'slug'=>$antorjatik8->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($antorjatik8->image)}}" alt="{{$antorjatik8->title}}" title="{{$antorjatik8->title}}"></a>

                                                <a href="#" class="video-icon3">  </a>
                                            </div>

                                            <h5 class="sec-two-title">
                                                <a href="{{route('news-detail',['id'=>$antorjatik8->id,'slug'=>$antorjatik8->slug])}}">{{$antorjatik8->title}}</a>
                                            </h5>
                                        </div>
                                    </div>
                                        @endforeach
                            ...
                            <div class="tab-pane fade" id="Info-tabs4" role="tabpanel" aria-labelledby="categori-tab4">
                                ...
                                <div class="row">
                                    <?php
                                    $totthoprojuktih = \App\Models\Category::where('status', 1)->skip(5)->take(1)->get();

                                    if ($totthoprojuktih->isNotEmpty()) {

                                        $totthoprojuktih8 = \App\Models\Post::where('category_id', $totthoprojukti_h->id)->skip(0)->take(8)->get();
                                    }

                                    ?>

                                    @foreach($totthoprojuktih8 as $totthoprojukti8)
                                    <div class="themesBazar-4 themesBazar-m2">
                                        <div class="sec-two-wrpp">
                                            <div class="section-two-image">
                                                <a href="{{route('news-detail',['id'=>$totthoprojukti8->id,'slug'=>$totthoprojukti8->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($totthoprojukti8->image)}}" alt="{{$totthoprojukti8->title}}" title="{{$totthoprojukti8->title}}"></a>

                                                <a href="#" class="video-icon3">  </a>
                                            </div>

                                            <h5 class="sec-two-title">
                                                <a href="{{route('news-detail',['id'=>$totthoprojukti8->id,'slug'=>$totthoprojukti8->slug])}}">{{$totthoprojukti8->title}}</a>
                                            </h5>
                                        </div>
                                    </div>
                                        @endforeach
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <h2 class="themesBazar_cat_one">
                        <?php
                        $saradesh = \App\Models\Category::where('status', 1)->skip(6)->take(1)->first();

                        $saradesh_name= $saradesh->category_name;

                        ?>
                        <span><a href="{{route('catagory-news',['id'=>$saradesh->id,'slug'=>$saradesh->slug])}}">{{$saradesh_name}} </a></span>
                        <span2><a href="{{route('catagory-news',['id'=>$saradesh->id,'slug'=>$saradesh->slug])}}"> আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h2>

                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <?php
                            $saradesh = \App\Models\Category::where('status', 1)->skip(6)->take(1)->get();

                            if ($saradesh->isNotEmpty()) {
                                $saradesh_id = $saradesh->first()->id;
                                $saradesh1 = \App\Models\Post::where('category_id', $saradesh_id)->latest()->take(1)->get();
                                $saradesh2 = \App\Models\Post::where('category_id', $saradesh_id)->skip(1)->take(2)->get();
                                $saradesh5 = \App\Models\Post::where('category_id', $saradesh_id)->skip(5)->take(5)->get();
                            }

                            ?>
                            @foreach($saradesh1 as $sara1)
                            <div class="secThree-bg">
                                <div class="sec-theee-image">
                                    <a href="{{route('news-detail',['id'=>$sara1->id,'slug'=>$sara1->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sara1->image)}}" alt="{{asset($logo->desktop_logo)}}" title="{{$sara1->title}}"></a>

                                    <a href="#" class="video-icon3">  </a>

                                </div>
                                <h4 class="secThree-title">
                                    <a href="{{route('news-detail',['id'=>$sara1->id,'slug'=>$sara1->slug])}}">{{$sara1->title}}</a>
                                </h4>
                            </div>
                                @endforeach
                            <div class="row">
                                ...
                                @foreach($saradesh2 as $sara2)
                                <div class="themesBazar-2 themesBazar-m2">
                                    <div class="secThree-wrpp">
                                        <div class="sec-theee-image2">
                                            <a href="{{route('news-detail',['id'=>$sara2->id,'slug'=>$sara2->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sara2->image)}}" alt="{{asset($logo->desktop_logo)}}" title="{{$sara2->title}}"></a>

                                            <a href="#" class="video-icon3">  </a>

                                        </div>
                                        <h4 class="secThree-title2">
                                            <a href="{{route('news-detail',['id'=>$sara2->id,'slug'=>$sara2->slug])}}">{{$sara2->title}}</a>
                                        </h4>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="bg2">
                                ...
                                @foreach($saradesh5 as $sara5)
                                <div class="secThree-smallItem">
                                    <div class="secThree-smallImg">
                                        <a href="{{route('news-detail',['id'=>$sara5->id,'slug'=>$sara5->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sara5->image)}}" alt="{{asset($logo->desktop_logo)}}" title="{{$sara5->title}}"></a>

                                        <a href="#" class="video-icon3">  </a>


                                        <h5 class="secOne_smallTitle">
                                            <a href="{{route('news-detail',['id'=>$sara5->id,'slug'=>$sara5->slug])}}"> {{$sara5->title}} </a>
                                        </h5>
                                    </div>
                                </div>
                                @endforeach
    ...
    s0.1,1.4,0.1,1.4l1,1.1l0.5,0.6l1.6-0.9l1.1-0.2c0,0,0-1.1,0-1.6s0-1,0-1l-0.6-0.5C317.8,142.6,317.4,142.5,316.5,142.1z"></path>
                                ...
                                <?php
                                $rangpur = \App\Models\SubCategory::where('status',1)->skip(12)->take(1)->first();


                                ?>

                                <g id="rangpur">
                                    <a href="{{route('sub-category-news',['id'=>$rangpur->id,'slug'=>$rangpur->slug])}}" xlink:href="#">
    ...
    C-149.4-371.1-151.4-371-152-370.6z"></path>
        ...
        c0.1-0.2,0.2-0.3,0.2-0.4c2.9-5.7,5.9-11.5,8.8-17.2C-84-295.5-83.8-298.3-84.8-301.1z"></path>
                                ...
                                <?php
                                $sylhet = \App\Models\SubCategory::where('status',1)->skip(10)->take(1)->first();

                                ?>

                                <g id="sylhet">
                                    <a href="{{route('sub-category-news',['id'=>$sylhet->id ,'slug'=>$sylhet->slug])}}" xlink:href="#">
    ...
    l-5,1.2l-4.8,1.5L143.6-178.4z"></path>
        ...
        c0.1-0.1,0.1-0.2,0.2-0.3c2.4-4.7,4.8-9.3,7.2-14C234-149.4,234.1-151.7,233.3-153.9z"></path>
            ...
            h2.1v1.9H246.6z"></path>
                                ...
                                <?php
                                $khulna = \App\Models\SubCategory::where('status',1)->skip(9)->take(1)->first();

                                ?>

                                <g id="khulna">
                                    <a href="{{route('sub-category-news',['id'=>$khulna->id,'slug'=>$khulna->slug])}}" xlink:href="#">
        ...
        c0.1-0.2,0.2-0.3,0.2-0.4c2.9-5.7,5.9-11.5,8.8-17.2C-43,63.5-42.7,60.8-43.7,58z"></path>
          ...
          c0-1.4,0.5-2.6,1.4-3.6c1-1,2.1-1.5,3.5-1.5c3,0,5.7,1.7,8,5v-9.7h-14.6v-2.2h19v2.2H-25.4z"></path>
                                ...
                                <?php
                                $dhaka_m = \App\Models\SubCategory::where('status',1)->skip(7)->take(1)->first();

                                ?>
                                <g id="dhaka">
                                    <a href="{{route('sub-category-news',['id'=>$dhaka_m->id,'slug'=>$dhaka_m->slug])}}" xlink:href="#">
          ...
          c0.1-0.2,0.2-0.3,0.2-0.4c2.9-5.7,5.9-11.5,8.8-17.2C84.7-57.8,84.9-60.6,83.9-63.4z"></path>
                                ...
                                <?php
                                $mymensingh = \App\Models\SubCategory::where('status',1)->skip(13)->take(1)->first();

                                ?>

                                <g id="mymensingh">
                                    <a href="{{route('sub-category-news',['id'=>$mymensingh->id,'slug'=>$mymensingh->slug])}}" xlink:href="#">
        ...
        c0.1-0.1,0.1-0.2,0.2-0.3c2.4-4.7,4.8-9.3,7.2-14C55.9-179.8,56.1-182.1,55.2-184.4z"></path>
          ...
          c2.7,1.1,5.3,2.5,7.9,4.4L115.1-134.9z"></path>
                                ...
                                <?php
                                $rajshahi = \App\Models\SubCategory::where('status',1)->skip(6)->take(1)->first();

                                ?>

                                <g id="rajshahi">
                                    <a href="{{route('sub-category-news',['id'=>$rajshahi->id,'slug'=>$rajshahi->slug])}}" xlink:href="#">
      ...
      l-1.2-1.6l-1.4,0.1h-1.5l-0.9,0.4l-2.5,0.9l-0.8,0.1c0,0-1,0-1.5,0.1s-1.9,0.1-1.9,0.1s-0.2,1-0.6,1.2s-0.4,0.2-0.4,0.2v1.2H-184z"></path>
        ...
        c0.1-0.2,0.2-0.3,0.2-0.4c2.9-5.7,5.9-11.5,8.8-17.2C-82.3-146.8-82.1-149.6-83.1-152.4z"></path>
          ...
          c0,0.2,0,0.3,0,0.5h1.9v2H-57z"></path>
                                ...
                                <?php
                                $borishal = \App\Models\SubCategory::where('status',1)->skip(11)->take(1)->first();

                                ?>
                                <g id="borishal">
                                    <a href="{{route('sub-category-news',['id'=>$borishal->id,'slug'=>$borishal->slug])}}" xlink:href="#">
        ...
        c0.1-0.2,0.2-0.3,0.2-0.4c2.9-5.7,5.9-11.5,8.8-17.2C73,140.5,73.3,137.8,72.3,135z"></path>
          ...
          c0-2.8,1.8-4.8,4.7-4.8c1.4,0,2.5,0.8,3.5,2.2c1-1.5,2.1-2.3,3.3-2.3c0.9,0,1.6,0.6,2.2,1.7v-5.4H92.1v-1.9h19.3v1.9H109.4z"></path>
                                ...
                                <?php
                                $chittagong = \App\Models\SubCategory::where('status',1)->skip(8)->take(1)->first();

                                ?>
                                <g id="chittagong">
                                    <a href="{{route('sub-category-news',['id'=>$chittagong->id ,'slug'=>$chittagong->slug])}}" xlink:href="#">
      ...
      s-0.4,0.6-0.6,0.8s0,0.4-0.4,0.5s-1.1,0-1.4,0s-0.8-0.1-0.8-0.1v-1.2c0,0-0.1-0.6,0.1-0.9s0.7-1.1,0.7-1.1L-13.8-155.7z"></path>
                    ...
                    <script src="{{asset('/')}}frontend/assets/js/googlejquery.min.js"></script>
    ...
    <section class="section-four">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <?php
                    $shikkha_culture = \App\Models\Category::where('status', 1)->skip(12)->take(1)->first();

                    $shikkha_culture_name= $shikkha_culture->category_name;
                    $shikkha_culture_id= $shikkha_culture->id;

                    ?>
                    <div class="themesBazar_cat">
                        <a href="{{route('catagory-news',['id'=>$shikkha_culture->id,'slug'=>$shikkha_culture->slug])}}"> {{$shikkha_culture_name}} </a>
                    ...
                    <div class="secFour-slider owl-carousel">
                        ...
                        <?php
                        $shikkha_culture0 = \App\Models\Category::where('status', 1)->skip(12)->take(1)->get();

                        if ($shikkha_culture0->isNotEmpty()) {

                            $shikkha_culture5 = \App\Models\Post::where('category_id',  $shikkha_culture_id)->skip(5)->take(5)->get();
                        }

                        ?>


                        @foreach($shikkha_culture5 as $shikkha_culture)

                        <div class="secFour-wrpp ">
                            <div class="secFour-image">
                                <a href="{{route('news-detail',['id'=>$shikkha_culture->id,'slug'=>$shikkha_culture->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($shikkha_culture->image)}}" alt="চবি ছাত্রলীগের সংঘর্ষে ক্যাম্পসে উত্তেজনা" title="চবি ছাত্রলীগের সংঘর্ষে ক্যাম্পসে উত্তেজনা"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFour-title">
                                    <a href="{{route('news-detail',['id'=>$shikkha_culture->id,'slug'=>$shikkha_culture->slug])}}"> {{$shikkha_culture->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
    ...
    <section class="section-five">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <?php
                    $sharebazar = \App\Models\Category::where('status', 1)->skip(14)->take(1)->first();
                    $sharebazar_name=$sharebazar->category_name;
                    $sharebazar_id=$sharebazar->id;

                    ?>

                    <h1 class="themesBazar_cat_one">

                        <span><a href="{{route('catagory-news',['id'=>$sharebazar_id,'slug'=>$sharebazar->slug])}}">{{$sharebazar_name}}</a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$sharebazar_id,'slug'=>$sharebazar->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">

                        <?php
                        $sharebazar0 = \App\Models\Category::where('status', 1)->skip(14)->take(1)->get();

                        if ($sharebazar0->isNotEmpty()) {

                            $sharebazar1 = \App\Models\Post::where('category_id', $sharebazar_id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $sharebazar3 = \App\Models\Post::where('category_id', $sharebazar_id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        }

                        ?>

                        @foreach($sharebazar1 as $sharebazar_single)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$sharebazar_single->id,'slug'=>$sharebazar_single->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sharebazar_single->image)}}" alt="{{$sharebazar_single->title}}" title="{{$sharebazar_single->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$sharebazar_single->id,'slug'=>$sharebazar_single->slug])}}"> {{$sharebazar_single->title}}</a>
                            </div>
                        </div>
                            @endforeach


                            @foreach($sharebazar3 as $share3)
                            <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$share3->id,'slug'=>$share3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($share3->image)}}" alt="{{$share3->title}}" title="{{$share3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$share3->id,'slug'=>$share3->slug])}}"> {{$share3->title}} </a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $drmr = \App\Models\Category::where('status', 1)->skip(17)->take(1)->first();
                    $drmr_name=$drmr->category_name;
                    $drmr_id=$drmr->id;
                    ...
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$drmr_id,'slug'=>$drmr->slug])}}">{{$drmr_name}}</a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$drmr_id,'slug'=>$drmr->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>
                    ...
                    <div class="white-bg">
                        ...
                        <?php
                        $drmr0 = \App\Models\Category::where('status', 1)->skip(17)->take(1)->get();

                        if ($drmr0->isNotEmpty()) {

                            $drmr1 = \App\Models\Post::where('category_id', $drmr_id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $drmr3 = \App\Models\Post::where('category_id', $drmr_id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        }

                        ?>
                        @foreach($drmr1 as $drmr_single)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$drmr_id,'slug'=>$drmr->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($drmr_single->image)}}" alt="{{$drmr_single->title}}" title="{{$drmr_single->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$drmr_single->id,'slug'=>$drmr_single->slug])}}">{{$drmr_single->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($drmr3 as $drmr03)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$drmr03->id,'slug'=>$drmr03->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($drmr03->image)}}" alt="{{$drmr03->title}}" title="{{$drmr03->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$drmr03->id,'slug'=>$drmr03->slug])}}">{{$drmr03->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $life_style = \App\Models\Category::where('status', 1)->skip(15)->take(1)->first();
                    $life_style_name=$life_style->category_name;
                    $life_style_id=$life_style->id;

                    ?>

                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$life_style->id,'slug'=>$life_style->slug])}}">{{$life_style_name}}</a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$life_style->id,'slug'=>$life_style->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">
                        <?php
                        $life_style_0 = \App\Models\Category::where('status', 1)->skip(15)->take(1)->get();

                        if ($life_style_0->isNotEmpty()) {

                            $life_style_1 = \App\Models\Post::where('category_id', $life_style_id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $life_style_3 = \App\Models\Post::where('category_id', $life_style_id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        }

                        ?>


                        @foreach($life_style_1 as $lifestyle_single)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$lifestyle_single->id,'slug'=>$lifestyle_single->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($lifestyle_single->image)}}" alt="{{$lifestyle_single->title}}" title="{{$lifestyle_single->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$lifestyle_single->id,'slug'=>$lifestyle_single->slug])}}">{{$lifestyle_single->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($life_style_3 as $life3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$life3->id,'slug'=>$life3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($life3->image)}}" alt="{{$life3->title}}" title="{{$life3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$life3->id,'slug'=>$life3->slug])}}">{{$life3->title}} </a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <?php
                    $agriculture = \App\Models\Category::where('status', 1)->skip(9)->take(1)->first();
                    $agriculture_name=$agriculture->category_name;
                    $agriculture_id=$agriculture->id;

                    ?>
                    <div class="themesBazar_cat">
                        <a href="{{route('catagory-news',['id'=>$agriculture_id,'slug'=>$agriculture->slug])}}"> {{$agriculture_name}} </a>
                        <span class="themeBazar"></span>
                    </div>
                    ...
                    <div class="secFour-slider owl-carousel">
                        ...
                        <?php
                        $agriculture_0 = \App\Models\Category::where('status', 1)->skip(9)->take(1)->get();

                        if ($agriculture_0->isNotEmpty()) {

                            $agriculture_5 = \App\Models\Post::where('category_id', $agriculture_id)->orderBy('id', 'desc')->skip(0)->take(5)->get();
                        }

                        ?>


                        @foreach($agriculture_5 as $agriculture5news)
                        <div class="secFour-wrpp ">
                            <div class="secFour-image">
                                <a href="{{route('news-detail',['id'=>$agriculture5news->id,'slug'=>$agriculture5news->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($agriculture5news->image)}}" alt="{{$agriculture5news->title}}" title="{{$agriculture5news->title}}"></a>

                                <a href="{{route('news-detail',['id'=>$agriculture5news->id,'slug'=>$agriculture5news->slug])}}" class="video-icon3">  </a>

                                <h5 class="secFour-title">
                                    <a href="{{route('news-detail',['id'=>$agriculture5news->id,'slug'=>$agriculture5news->slug])}}"> {{$agriculture5news->title}} </a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $education = \App\Models\Category::where('status', 1)->skip(7)->take(1)->first();
//                    $education_name=$education->category_name;
//                    $education_id=$education->id;

                    ?>
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$education->id,'slug'=>$education->slug])}}">{{$education->category_name}} </a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$education->id,'slug'=>$education->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">

                        <?php
                        $education_0 = \App\Models\Category::where('status', 1)->skip(7)->take(1)->get();

                        if ($education_0->isNotEmpty()) {

                            $education_1 = \App\Models\Post::where('category_id', $education->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $education_3 = \App\Models\Post::where('category_id', $education->id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        }

                        ?>


                        @foreach($education_1 as $edu1)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$edu1->id,'slug'=>$edu1->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($edu1->image)}}" alt="{{$edu1->title}}" title="{{$edu1->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$edu1->id,'slug'=>$edu1->slug])}}">{{$edu1->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($education_3 as $edu3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$edu3->id,'slug'=>$edu3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($edu3->image)}}" alt="{{$edu3->title}}" title="{{$edu3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$edu3->id,'slug'=>$edu3->slug])}}"> {{$edu3->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $ain_adalot = \App\Models\Category::where('status', 1)->skip(11)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$ain_adalot->id,'slug'=>$ain_adalot->slug])}}">{{$ain_adalot->category_name}} </a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$ain_adalot->id,'slug'=>$ain_adalot->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">

                        <?php
                        $ain_adalot_0 = \App\Models\Category::where('status', 1)->skip(11)->take(1)->get();

                        if ($ain_adalot_0->isNotEmpty()) {

                            $ain_adalot_1 = \App\Models\Post::where('category_id', $ain_adalot->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $ain_adalot_3 = \App\Models\Post::where('category_id', $ain_adalot->id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        }

                        ?>


                        @foreach($ain_adalot_1 as $ain_adalat_single )
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$ain_adalat_single->id,'slug'=>$ain_adalat_single->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($ain_adalat_single->image)}}" alt="{{$ain_adalat_single->title}}" title="শ{{$ain_adalat_single->title}}"></a>

{{--                            <a href="#" class="video-icon3">  <a href="135.html" class="video-icon5"><i class="la la-play"></i></a>  </a>--}}


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$ain_adalat_single->id,'slug'=>$ain_adalat_single->slug])}}"> {{$ain_adalat_single->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($ain_adalot_3 as $ain_3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$ain_3->id,'slug'=>$ain_3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($ain_3->image)}}" alt="{{$ain_3->title}}" title="{{$ain_3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$ain_3->id,'slug'=>$ain_3->slug])}}"> {{$ain_3->title}} </a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $bussiness = \App\Models\Category::where('status', 1)->skip(13)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$bussiness->id,'slug'=>$bussiness->slug])}}">{{$bussiness->category_name}}</a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$bussiness->id,'slug'=>$bussiness->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">

                        <?php
                        $bussiness_0 = \App\Models\Category::where('status', 1)->skip(13)->take(1)->get();

                        if ($ain_adalot_0->isNotEmpty()) {

                            $bussiness_1 = \App\Models\Post::where('category_id', $bussiness->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $bussiness_3 = \App\Models\Post::where('category_id', $bussiness->id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        }

                        ?>

                        @foreach($bussiness_1 as $bussiness_single)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$bussiness_single->id,'slug'=>$bussiness_single->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($bussiness_single->image)}}" alt="{{$bussiness_single->title}}" title="{{$bussiness_single->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$bussiness_single->id,'slug'=>$bussiness_single->slug])}}">{{$bussiness_single->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($bussiness_3 as $bussiness3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$bussiness3->id,'slug'=>$bussiness3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($bussiness3->image)}}" alt="{{$bussiness3->title}}" title="{{$bussiness3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$bussiness3->id,'slug'=>$bussiness3->slug])}}"> {{$bussiness3->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <?php
                    $editoral = \App\Models\Category::where('status', 1)->skip(18)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <div class="themesBazar_cat">
                        <a href="{{route('catagory-news',['id'=>$editoral->id,'slug'=>$editoral->slug])}}"> {{$editoral->category_name}} </a>
                        <span class="themeBazar"></span>
                    </div>
                    ...
                    <div class="secFour-slider owl-carousel">
                        ...
                        <?php
                        $editoral_0 = \App\Models\Category::where('status', 1)->skip(18)->take(1)->get();

                        if ($editoral_0->isNotEmpty()) {

                            $editoral_5 = \App\Models\Post::where('category_id', $editoral->id)->orderBy('id', 'desc')->skip(0)->take(5)->get();
                        ...
                        @foreach($editoral_5 as $editoral5)
                        <div class="secFour-wrpp ">
                            <div class="secFour-image">
                                <a href="{{route('news-detail',['id'=>$editoral5->id,'slug'=>$editoral5->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($editoral5->image)}}" alt="{{$editoral5->title}}" title="{{$editoral5->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFour-title">
                                    <a href="{{route('news-detail',['id'=>$editoral5->id,'slug'=>$editoral5->slug])}}"> {{$editoral5->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
    ...
    <section class="section-seven">
        <div class="container">
            <h2 class="themesBazar_cat3">
                <?php
                $binodon = \App\Models\Category::where('status', 1)->skip(4)->take(1)->first();
                //                    $education_name=$education->category_name;
                //                    $education_id=$education->id;

                ?>
                <a href="{{route('catagory-news',['id'=>$binodon->id,'slug'=>$binodon->slug])}}">{{$binodon->category_name}} </a>
                <span class="themeBazar3"></span>
            </h2>
            <div class="secSecven-color">
                <div class="row">
                    <?php
                    $binodon_0 = \App\Models\Category::where('status',1)->skip(4)->take(1)->get();

                    if ($binodon_0->isNotEmpty()) {

                        $binodon_1 = \App\Models\Post::where('category_id', $binodon->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                        $binodon_4 = \App\Models\Post::where('category_id', $binodon->id)->orderBy('id', 'desc')->skip(1)->take(4)->get();
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        @foreach($binodon_1 as $binodon1)
                        <div class="black-bg">
                            <div class="secSeven-image">
                                <a href="{{route('news-detail',['id'=>$binodon1->id,'slug'=>$binodon1->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($binodon1->image)}}" alt="{{$binodon1->title}}" title="{{$binodon1->title}}"></a>


                            </div>
                            <h6 class="secSeven-title">
                                <a href="{{route('news-detail',['id'=>$binodon1->id,'slug'=>$binodon1->slug])}}"> {{$binodon1->title}}</a>
                            </h6>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="row">
                            ...
                            @foreach($binodon_4 as $binodon4)
                            <div class="themesBazar-2 themesBazar-m2">
                                <div class="secSeven-wrpp ">
                                    <div class="secSeven-image2">
                                        <a href="{{route('news-detail',['id'=>$binodon4->id,'slug'=>$binodon4->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($binodon4->image)}}" alt="{{$binodon4->title}}" title="{{$binodon4->title}}"></a>

                                        <a href="#" class="video-icon3">  </a>

                                        <h5 class="secSeven-title2">
                                            <a href="{{route('news-detail',['id'=>$binodon4->id,'slug'=>$binodon4->slug])}}">{{$binodon4->title}}</a>
                                        </h5>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $health = \App\Models\Category::where('status', 1)->skip(10)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$health->id,'slug'=>$health->slug])}}">{{$health->category_name}}</a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$health->id,'slug'=>$health->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">

                        <?php
                        $health_0 = \App\Models\Category::where('status',1)->skip(10)->take(1)->get();

                        if ($health_0->isNotEmpty()) {

                            $health_1 = \App\Models\Post::where('category_id', $health->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $health_3 = \App\Models\Post::where('category_id', $health->id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        ...
                        @foreach($health_1 as $health1)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$health1->id,'slug'=>$health1->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($health1->image)}}" alt="{{$health1->title}}" title="{{$health1->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$health1->id,'slug'=>$health1->slug])}}">{{$health1->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($health_3 as $health3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$health3->id,'slug'=>$health3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($health3->image)}}" alt="{{$health3->title}}" title="{{$health3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$health3->id,'slug'=>$health3->slug])}}"> {{$health3->title}} </a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    <?php
                    $projukti = \App\Models\Category::where('status', 1)->skip(5)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;
                    ...
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$projukti->id,'slug'=>$projukti->slug])}}">{{$projukti->category_name}} </a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$projukti->id,'slug'=>$projukti->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">

                        <?php
                        $projukti_0 = \App\Models\Category::where('status',1)->skip(5)->take(1)->get();

                        if ($projukti_0->isNotEmpty()) {

                            $projukti_1 = \App\Models\Post::where('category_id', $projukti->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $projukti_3 = \App\Models\Post::where('category_id', $projukti->id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        ...
                        @foreach($projukti_1 as $projukti1)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$projukti1->id,'slug'=>$projukti1->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($projukti1->image)}}" alt="{{$projukti1->title}}" title="{{$projukti1->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$projukti1->id,'slug'=>$projukti1->slug])}}">{{$projukti1->title}}</a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($projukti_3 as $projukti3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$projukti3->id,'slug'=>$projukti3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($projukti3->image)}}" alt="{{$projukti3->title}}" title="{{$projukti3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$projukti3->id,'slug'=>$projukti3->slug])}}">{{$projukti3->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    <?php
                    $motamot = \App\Models\Category::where('status', 1)->skip(19)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;
                    ...
                    <h1 class="themesBazar_cat_one">
                        <span><a href="{{route('catagory-news',['id'=>$motamot->id,'slug'=>$motamot->slug])}}">{{$motamot->category_name}} </a> </span>
                        <span2><a href="{{route('catagory-news',['id'=>$motamot->id,'slug'=>$motamot->slug])}}">  আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </h1>

                    <div class="white-bg">
                        <?php
                        $motamot_0 = \App\Models\Category::where('status',1)->skip(5)->take(1)->get();

                        if ($motamot_0->isNotEmpty()) {

                            $motamot_1 = \App\Models\Post::where('category_id', $motamot->id)->orderBy('id', 'desc')->skip(0)->take(1)->get();
                            $motamot_3 = \App\Models\Post::where('category_id', $motamot->id)->orderBy('id', 'desc')->skip(1)->take(3)->get();
                        ...
                        @foreach($motamot_1 as $motamot1)
                        <div class="secFive-image">
                            <a href="{{route('news-detail',['id'=>$motamot1->id,'slug'=>$motamot1->slug])}}"><img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($motamot1->image)}}" alt="{{$motamot1->title}}" title="{{$motamot1->title}}"></a>

                            <a href="#" class="video-icon3">  </a>


                            <div class="secFive-title">
                                <a href="{{route('news-detail',['id'=>$motamot1->id,'slug'=>$motamot1->slug])}}"> {{$motamot1->title}} </a>
                            </div>
                        </div>
                            @endforeach

                            @foreach($motamot_3 as $motamot3)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="{{route('news-detail',['id'=>$motamot3->id,'slug'=>$motamot3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($motamot3->image)}}" alt="{{$motamot3->title}}" title="{{$motamot3->title}}"></a>

                                <a href="#" class="video-icon3">  </a>

                                <h5 class="secFive_title2">
                                    <a href="{{route('news-detail',['id'=>$motamot3->id,'slug'=>$motamot3->slug])}}">{{$motamot3->title}}</a>
                                </h5>
                            </div>
                        </div>
                            @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9">
                    ...
                    <?php
                    $sports = \App\Models\Category::where('status', 1)->skip(3)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <div class="themesBazar_cat2">
                        <a href="{{route('catagory-news',['id'=>$sports->id,'slug'=>$sports->slug])}}"> {{$sports->category_name}} </a>
                    ...
                    <div class="row">
                        ...
                        <?php
                        $sports_0 = \App\Models\Category::where('status', 1)->skip(18)->take(1)->get();

                        if ($sports_0->isNotEmpty()) {

                            $sports_3 = \App\Models\Post::where('category_id', $sports->id)->orderBy('id', 'desc')->skip(0)->take(3)->get();
                            $sports_4 = \App\Models\Post::where('category_id', $sports->id)->orderBy('id', 'desc')->skip(3)->take(4)->get();

                        }

                        ?>

                        @foreach($sports_3 as $sports3)
                        <div class="themesBazar-3 themesBazar-m2">
                            <div class="secEight-wrpp bg-4">
                                <div class="secEight-image">
                                    <a href="{{route('news-detail',['id'=>$sports3->id,'slug'=>$sports3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sports3->image)}}" alt="{{$sports3->title}}" title="{{$sports3->title}}"></a>

                                    <a href="#" class="video-icon3">  </a>

                                </div>
                                <h2 class="secEight-title">
                                    <a href="{{route('news-detail',['id'=>$sports3->id,'slug'=>$sports3->slug])}}">{{$sports3->title}} </a>
                                </h2>
                            </div>
                        </div>
                            @endforeach
                    ...
                    <div class="row">
                        ...
                        @foreach($sports_4 as $sport4)
                        <div class="themesBazar-4 themesBazar-m2">
                            <div class="secEight-wrpp2 bg-4">
                                <div class="secEight-image2">
                                    <a href="{{route('news-detail',['id'=>$sport4->id,'slug'=>$sport4->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($sport4->image)}}" alt="{{$sport4->title}}" title="শ{{$sport4->title}}"></a>

                                    <a href="#" class="video-icon3">  </a>

                                </div>
                                <h2 class="secEight-title">
                                    <a href="{{route('news-detail',['id'=>$sport4->id,'slug'=>$sport4->slug])}}"> {{$sport4->title}}</a>
                                </h2>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="facebook-content">
                        ...
                        <iframe
                            src="https://www.facebook.com/plugins/page.php?href=https://www.facebook.com/journalist.monir&amp;tabs=time&amp;width=280&amp;height=120&amp;small_header=false&amp;adapt_container_width=true&amp;hide_cover=false&amp;show_facepile=true&amp;appId=334182264340964"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $auamiligue = \App\Models\SubCategory::where('status', 1)->skip(0)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <div class="themesBazar_cat_one">
                        <span><a href="{{route('sub-category-news',['id'=>$auamiligue->id,'slug'=>$auamiligue->slug])}}"> {{$auamiligue->name}} </a> </span>
                        <span2><a href="{{route('sub-category-news',['id'=>$auamiligue->id,'slug'=>$auamiligue->slug])}}"> আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </div>
                        <?php
                        $auamiligue_0 = \App\Models\SubCategory::where('status', 1)->skip(0)->take(1)->get();

                        if ($auamiligue_0->isNotEmpty()) {

                            $auamiligue_3 = \App\Models\Post::where('subcategory_id', $auamiligue->id)->orderBy('id', 'desc')->skip(0)->take(3)->get();
                        }

                        ?>

                        @foreach($auamiligue_3 as $auamiligue3)
                    <div class="secOne-smallItem">
                        <div class="secOne-smallImg2">
                            <a href="{{route('news-detail',['id'=>$auamiligue3->id,'slug'=>$auamiligue3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($auamiligue3->image)}}" alt="{{$auamiligue3->title}}" title="{{$auamiligue3->title}}"></a>

                            <a href="#" class="video-icon3">  </a>

                            <h5 class="secOne_smallTitle">
                                <a href="{{route('news-detail',['id'=>$auamiligue3->id,'slug'=>$auamiligue3->slug])}}">{{$auamiligue3->title}} </a>
                            </h5>
                        </div>
                    </div>
                        @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    <?php
                    $cricket = \App\Models\SubCategory::where('status', 1)->skip(3)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <div class="themesBazar_cat_one">
                        <span><a href="{{route('sub-category-news',['id'=>$cricket->id,'slug'=>$cricket->slug])}}">{{$cricket->name}} </a> </span>
                        <span2><a href="{{route('sub-category-news',['id'=>$cricket->id,'slug'=>$cricket->slug])}}"> আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </div>
                        <?php
                        $cricket_0 = \App\Models\SubCategory::where('status', 1)->skip(3)->take(1)->get();

                        if ($cricket_0->isNotEmpty()) {

                            $cricket_3 = \App\Models\Post::where('subcategory_id', $cricket->id)->orderBy('id', 'desc')->skip(0)->take(3)->get();
                        }

                        ?>

                        @foreach($cricket_3 as $cricket3)
                    <div class="secOne-smallItem">
                        <div class="secOne-smallImg2">
                            <a href="{{route('news-detail',['id'=>$cricket3->id,'slug'=>$cricket3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($cricket3->image)}}" alt="{{$cricket3->title}}" title="{{$cricket3->title}}"></a>

                            <a href="#" class="video-icon3">  </a>

                            <h5 class="secOne_smallTitle">
                                <a href="{{route('news-detail',['id'=>$cricket3->id,'slug'=>$cricket3->slug])}}">{{$cricket3->title}} </a>
                            </h5>
                        </div>
                    </div>
                        @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $dhaka = \App\Models\SubCategory::where('status', 1)->skip(7)->take(1)->first();
                    //                    $education_name=$education->category_name;
                    //                    $education_id=$education->id;

                    ?>
                    <div class="themesBazar_cat_one">
                        <span><a href="{{route('sub-category-news',['id'=>$dhaka->id,'slug'=>$dhaka->slug])}}">{{$dhaka->name}} </a> </span>
                        <span2><a href="{{route('sub-category-news',['id'=>$dhaka->id,'slug'=>$dhaka->slug])}}"> আরো খবর <i class="la la-angle-double-right"></i></a>  </span2>
                    </div>
                        <?php
                        $dhaka_0 = \App\Models\SubCategory::where('status', 1)->skip(7)->take(1)->get();

                        if ($dhaka_0->isNotEmpty()) {

                            $dhaka_3 = \App\Models\Post::where('subcategory_id', $dhaka->id)->orderBy('id', 'desc')->skip(0)->take(3)->get();
                        }

                        ?>

                        @foreach($dhaka_3 as $dhaka3)
                    <div class="secOne-smallItem">
                        <div class="secOne-smallImg2">
                            <a href="{{route('news-detail',['id'=>$dhaka3->id,'slug'=>$dhaka3->slug])}}"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($dhaka3->image)}}" alt="{{$dhaka3->title}}" title="স{{$dhaka3->title}}"></a>

                            <a href="#" class="video-icon3">  </a>

                            <h5 class="secOne_smallTitle">
                                <a href="{{route('news-detail',['id'=>$dhaka3->id,'slug'=>$dhaka3->slug])}}">{{$dhaka3->title}}</a>
                            </h5>
                        </div>
                    </div>
                        @endforeach
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    ...
                    <div class="homeGallery owl-carousel">
                        ...
                        @foreach($sliders as $Sliderp)
                        <div class="item" >
                            <div class="photo">
                                <a class="themeGallery" href="{{asset($Sliderp->image)}}">
                                    <img src="{{asset($Sliderp->image)}}" alt="{{$Sliderp->title}}" /></a>
                                <h3 class="photoCaption">
                                    <a href="#"> {{$Sliderp->title}} </a>
                                </h3>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <?php
                    $vidio5 = \App\Models\Video::where('status', 1)->latest()->take(5)->get();

                    ?>

                    <div class="white-bg">

                        @foreach($vidio5 as $video)
                        <div class="secFive-smallItem">
                            <div class="secFive-smallImg">
                                <a href="#"> <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($video->image)}}"></a>

                                <a href="https://www.youtube.com/watch?v=ge4TfSSUnlc" class="video-icon popup"><i class="las la-video"></i></a>
