            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="rachive-info-cats">
                        <a href="{{route('home')}}"><i class="las la-home"> </i> </a>  <i class="las la-angle-right"></i> {{ $postWithCategory->category_name }}
                    </div>

                    <div class="archivePage-content2">
                        <div class="row">
                            @foreach($categoryNewses as $catnews)
                            <div class="themesBazar-3 themesBazar-m2">
                                <div class="archivePage-wrpp2">
                                    <div class="archive2-image">
                                        <img class="lazyload" src="{{asset($logo->desktop_logo)}}" data-src="{{asset($catnews->image)}}" alt="{{asset($logo->desktop_logo)}}" title="{{$catnews->title}}">



                                    </div>
                                    <h4 class="archivePage2-title">
                                        <a href="{{route('news-detail',['id'=>$catnews->id,$catnews->slug])}}"> {{$catnews->title}} </a>
                                    </h4>
                                    ...
                                    <div class="archive-meta2">
                                        <a href="#"><i class="las la-tags"> </i>
                                            ...
                                            @php
                                                ...
                                                $created_at = \Carbon\Carbon::parse($catnews->created_at);
                            ...
                            <div style="text-align: center; margin:20px; display:display: ruby;">
                                 <nav>


                                        {{ $categoryNewses->links('pagination::bootstrap-4', ['prev_text' => 'Previous', 'next_text' => 'Next']) }}
